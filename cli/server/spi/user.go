...
// NewUser returns a user object
func NewUser(user *UserInfo) User {
	return user
}

// GetAttributes returns the attributes associated with the user
func (u *UserInfo) GetAttributes() ([]idp.Attribute, error) {
