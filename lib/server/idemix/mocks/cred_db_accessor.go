...
func (_m *CredDBAccessor) GetCredential(revocationHandle string) (*idemix.CredRecord, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(string) (*idemix.CredRecord, error)); ok {
		return rf(revocationHandle)
	}
...
// NewCredDBAccessor creates a new instance of CredDBAccessor. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewCredDBAccessor(t interface {
	mock.TestingT
	Cleanup(func())
}) *CredDBAccessor {
	mock := &CredDBAccessor{}
