...
// NewServerRequestCtx creates a new instance of ServerRequestCtx. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewServerRequestCtx(t interface {
	mock.TestingT
	Cleanup(func())
}) *ServerRequestCtx {
	mock := &ServerRequestCtx{}
	mock.Mock.Test(t)
